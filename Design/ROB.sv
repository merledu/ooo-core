    ...
    always_ff @(posedge CLK) begin
        if (reset) begin
            ...
            if (branch_mispredicted) begin
                ...
                dis_biq_address <= ROB[branch_rob_index].biq_address;
            end
            ...
            if(!rob_full) begin
                ...
                ROB[rob_tail_ptr[ROB_PTR_SIZE-1:0]].biq_address   <= rn_biq_address;
                //for 2nd instruction
                ...
                ROB[ROB_PTR_SIZE'(rob_tail_ptr[ROB_PTR_SIZE-1:0]+1)].biq_address <= rn_biq_address;
            end
        end
    end
endmodule
